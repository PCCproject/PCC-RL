...
from simulator.trace import generate_traces, generate_trace_from_config
...
register(id='PccNs-v0', entry_point='simulator.network_genet_udr:SimulatedNetworkEnv')
