...
from simulator.aurora_cl2 import Aurora
...
def parse_args():
    ...
    parser.add_argument("--randomization-range-file", type=str, required=True,
                        help="List of json file which contains a list of "
...
def main():
    ...
    aurora.train(args.randomization_range_file,
                 args.total_timesteps, tot_trace_cnt=10,
