...
class SimulatedNetworkEnv(gym.Env):
    ...
    def insert_to_difficulty_cache(self, traces):
        len_cache = 100
        ...
        # for k, v in self.difficulty_trace_cache.items():
        #     print(k, len(v))
...
register(id='PccNs-v0', entry_point='simulator.network_cl2:SimulatedNetworkEnv')
