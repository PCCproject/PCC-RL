...
from simulator import network_cl2
...
class SaveOnBestTrainingRewardCallback(BaseCallback):
    ...
    def _on_step(self) -> bool:
        if self.n_calls % self.check_freq == 0:
            self.model.env.curr_diff = int(self.num_timesteps // 144000) #144000
            print(self.num_timesteps, 'current level', self.model.env.curr_diff)
            # print(i * 36, (i+1)*36)
