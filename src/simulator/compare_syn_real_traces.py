...
width = 0.7
fig, ax = plt.subplots()
ax.bar([3, 6], [avg_udr_big_rewards, real_trace_avg_udr_big_rewards], width,
       yerr=[avg_udr_big_rewards_errs, real_trace_avg_udr_big_rewards_errs],
              color="C4", alpha=1, label='DRL-based Policy')
ax.bar([4, 7], [avg_cubic_rewards, real_trace_avg_cubic_rewards], width,
...
ax.set_xticklabels(["Simulation", 'Real testbed'])
