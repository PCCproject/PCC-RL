...
TO RUN SINGLE/DOUBLE AGENT EXPERIMENT:
    # python3 train_maddpg_simple.py --max-episode-len 100 --save-rate 100 --num-agents 1 --log-dir 1 --num-episodes 40000 --lr 1e-3
    # python3 train_maddpg_simple.py --max-episode-len 100 --save-rate 100 --num-agents 2 --log-dir 2e20 --num-episodes 40000 --lr 1e-2
...
from maddpg2.maddpg2.trainer.simple_network_sim import SimulatedMultAgentNetworkEnv
